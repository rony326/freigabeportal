...
| [rechnungs-workflow.md](rechnungs-workflow.md) | Der zentrale Prozess: Status-Modell einer Rechnung, Kontierung, Freigabe 1/2, Ablehnung, Aufsplitten, Löschung |
...
| [geplante-jobs-und-benachrichtigungen.md](geplante-jobs-und-benachrichtigungen.md) | Die vier automatischen Hintergrund-Jobs, E-Mail-Versand, Eskalationslogik |
